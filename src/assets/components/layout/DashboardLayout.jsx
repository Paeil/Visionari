...
import { LayoutGrid, Settings, ChevronDown, LogOut, ArrowLeft, Plus, Download, Megaphone, Copy, Check, X, RefreshCw, Lock, Eye, EyeOff, Menu } from 'lucide-react';
...
export default function DashboardLayout({ 
    ...
    return (
        <div className="min-h-screen bg-[#F5F7F9] relative font-sans w-full overflow-x-hidden">
            ...
            {/* RED HEADER BACKDROP */}
            <div className={`absolute top-0 left-0 w-full bg-gradient-to-r from-[#be1a1a] to-[#cc4e04] rounded-b-[40px] z-0 transition-all duration-300 ${showBackButton ? 'h-[230px]' : 'h-[320px]'}`}></div>
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <nav className="flex justify-between items-center px-4 md:px-10 py-6 gap-2">
                    ...
                    {/* Center: Navigation Pills (Visible on all screens) */}
...
<div className="hidden md:flex items-center gap-6">
    ...
    {/* =========================================
        ...
        IMPORTANT: relative is needed here
    ========================================= */}
    <div className="relative">
        ...
        {isProfileDropdownOpen && (
            <>
                ...
                {/* Dropdown */}
                <div
                    className="absolute top-full right-0 mt-3 w-56 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-200"
                >
            ...
            {/* ==================================================
                MOBILE SLIDE-OUT MENU (Actions Only)
            ================================================== */}
            {isMobileMenuOpen && (
